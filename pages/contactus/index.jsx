...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Name.length < 2 || Name.length > 50 || !/^[a-zA-Z\s]+$/.test(Name)) {
      alert('Please enter a valid full name (only letters, min 2 characters).');
      return;
    }
    ...
    if (subject.length < 5 || subject.length > 100) {
      alert('Subject should be between 5 and 100 characters.');
      return;
    }
      ...
      <section className="relative pt-32 pb-16 px-6 sm:px-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            ...
            Let's discuss how Agentsify can accelerate your success.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 backdrop-blur-sm">
                <h2 className="text-2xl font-bold text-white mb-6">Reach Out to Us</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">Get in touch via email</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">Click below to schedule a call:</h3>
                      <button
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 backdrop-blur-sm">
                <h2 className="text-2xl font-bold text-white mb-6">Why Choose Agentsify?</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">Quick Implementation</p>
                      <p className="text-gray-300 text-sm">Get started in 24-48 hours</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Bank-level data protection</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">5-Star Rating</p>
                      <p className="text-gray-300 text-sm">Trusted by companies</p>
                    </div>
                  </div>
                </div>
              </div>
