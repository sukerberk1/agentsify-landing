...
import { Users, Target, Award, Heart, ArrowRight, Sparkles, Globe, Zap, Eye, Compass, Clock, Lightbulb, Rocket } from 'lucide-react';
    ...
    const values = [
        {
            letter: 'A',
            title: 'Agile',
            description: 'We adapt quickly and deliver with speed and flexibility.',
        ...
        },
        {
            ...
            description: 'We drive sustainable growth and continuous evolution.',
        ...
        },
        {
            ...
            description: 'We leverage cutting-edge technology to build the future.',
        ...
        },
        {
            ...
            description: 'We focus on solving real problems with innovation.',
    ...
    const timelineItems = [
        {
            year: 'Q4 2024',
            title: 'The Beginning',
            description: 'Founded Agentsify with a vision to make AI accessible to every business.',
        ...
        },
        {
            year: 'Q1 2025',
            title: 'First MVP',
            description: 'Completed our first AI agent prototype and secured initial funding.',
            icon: <Rocket size={20} />,
                ...
                <div className="relative z-10 text-center max-w-3xl mx-auto">
                    <div className="space-y-4">
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed mb-2">
                            We're a team of passionate innovators dedicated to transforming ideas into reality and creating meaningful impact through technology.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 mb-16">
                        ...
                        <div className="group relative flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-bold text-blue-400 mt-6 mb-2">Vision</h3>
                            <p className="text-center text-gray-300 text-m max-w-xs leading-relaxed">
                                To be the global leader in intelligent automation, shaping the future of AI-driven business solutions.
                            </p>
                        </div>
                        ...
                        <div className="group relative flex flex-col items-center lg:scale-110">
                            ...
                            <h3 className="text-3xl font-bold text-teal-400 mt-6 mb-3">Mission</h3>
                            <p className="text-center text-gray-300 max-w-sm leading-relaxed">
                                To empower businesses worldwide by democratizing access to cutting-edge AI technology,
                                making intelligent automation accessible to all.
                            </p>
                        </div>
                        ...
                        <div className="group relative flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-bold text-orange-400 mt-6 mb-2">Goals</h3>
                            <p className="text-center text-gray-300 text-m max-w-xs leading-relaxed">
                                Expand presence across international markets to establish leadership in intelligent automation.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
                            These three pillars form the foundation of everything we do at Agentsify.
                            Our vision guides our direction, our mission drives our purpose, and our goals shape our future.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                            From founding to early adoption - here's how we've grown since our founding in 2024.
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        <div className="relative">
                            <div className="hidden lg:grid lg:grid-cols-3 gap-8 items-center justify-center max-w-5xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className={`transition-colors duration-300 ${activeValue === index
                                            ? 'text-black-600'
                                            : 'text-black-300'
                                            }`}>
                                            {value.icon}
            ...
            <section className="py-12 bg-gradient-to-br from-slate-800 via-indigo-900/20 to-slate-900 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                            The passionate minds behind Agentsify, working together to revolutionize AI automation.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Stan</h3>
                                <p className="text-purple-400 font-semibold mb-3">Founder & CEO</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Stan, our CEO & Founder, leads with a practical, hands-on approach to execution and team focus
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Cyril Leonov</h3>
                                <p className="text-blue-400 font-semibold mb-3">COO</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Kirill, our COO, ensures strategic priorities are aligned and drives business growth opportunities
                                </p>
                            </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Evgeny Demidovich</h3>
                                <p className="text-green-400 font-semibold mb-3">CTO </p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Evgeny, our CTO, ensures we choose the right technologies and use them effectively to build robust, scalable solutions
                                </p>
                            </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Wolfgang Eigner</h3>
                                <p className="text-yellow-400 font-semibold mb-3">CMO</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Wolfgang, our CMO, leads our marketing strategy and shapes how we connect with and engage our clients
                                </p>
                            </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Szymon Lisiecki</h3>
                                <p className="text-[#0066ff] font-semibold mb-3">Co-Founder</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Szymon, our Co-founder, brings deep technical expertise and a passion for crafting innovative solutions that push boundaries
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Axel Mengara</h3>
                                <p className="text-red-400 font-semibold mb-3">Founding Engineer</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Axel holds a PhD in AI & Data Science and brings over 8 years of experience delivering end-to-end AI solutions
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Krzysztof Szymanski</h3>
                                <p className="text-indigo-400 font-semibold mb-3">Founding Engineer</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Krzysztof is a seasoned tech leader with 15+ years of experience translating business needs into impactful digital solutions
                                </p>
                            </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Chris Kinsman </h3>
                                <p className="text-[#ff00ff] font-semibold mb-3">Founding Engineer</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Chris is a full-stack developer focused on building robust AI applications and seamless user experiences
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Paul Amnuaypayoat</h3>
                                <p className="text-[#a0f0ff] font-semibold mb-3">Founding Engineer</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Paul is an experienced software engineer with a passion for building scalable, high-performance AI solutions
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-white mb-1">Vaishnavi Mantri</h3>
                                <p className="text-[#ACE1AF] font-semibold mb-3">Founding Engineer</p>
                                <p className="text-gray-300 text-sm leading-relaxed">
                                    Vaishnavi is an AI engineer shaping intelligent systems through innovation and academic rigor
                                </p>
                            </div>
                        </div>
            ...
            <section className="py-10 bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-8 text-gray-400">
                        ...
                        <div className="flex items-center gap-2">
                            <Zap size={16} />
                            <span className="text-sm">Get started in 24 hours</span>
                        </div>
                    </div>
                </div>
            </section>
