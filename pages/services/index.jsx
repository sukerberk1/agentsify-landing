...
import { GiDart, GiStairsGoal } from "react-icons/gi";
...
const AITrainingMockup = () => {
  ...
  const modules = [
    { name: 'AI Basics', completed: true, icon: <SiMusicbrainz /> },
    { name: 'Data Science', completed: false, icon: <MdAdminPanelSettings /> },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        >
          <span className="mr-2"><MdOutlineLibraryBooks /></span>
      ...
      <div className="space-y-2">
        <div className="text-orange-300 text-xs mb-2 flex items-center">
          <span className="mr-1"><GiDart /></span>
...
const Services = () => {
  ...
  console.log('=== SERVICES TRANSLATION DEBUG ===');
  console.log('Translation ready:', ready);
  console.log('Current language:', i18n.language);
  console.log('Sample translation:', t("servicestab.tile1title"));
  console.log('Translation test:', t("servicestab.tile1title") !== "servicestab.tile1title");
  console.log('=================================');

  const fallbackServices = [
    {
      title: "AI Solution Development: Tailored to Your Business",
      description: "Turn your vision into reality with custom-built AI solutions. At Agentsify, we specialize in developing AI-powered systems that address your unique business challenges.",
    ...
    },
    {
      ...
      description: "Harness the true potential of AI with a strategy designed for your business success. At Agentsify, we identify key opportunities for AI integration.",
    ...
    },
    {
      ...
      description: "Unlock the full potential of your data with Agentsify's AI Data Management services. Our experts clean, organize, and integrate raw datasets.",
    ...
    },
    {
      ...
      description: "Equip your team with the skills to harness AI's full potential. At Agentsify, we deliver personalized AI training programs tailored to your business needs.",
      gradient: "from-fuchsia-900/30 to-pink-900/30",
    ...
    },
    {
      ...
      description: "Maximize your AI performance with Agentsify's proactive monitoring and 24/7 support. Our team ensures your AI systems stay reliable and efficient.",
  ...
  const services = ready && i18n.language ? [
    {
      title: t("servicestab.tile1title"),
      description: t("servicestab.tile1description"),
      gradient: "from-violet-900/30 to-fuchsia-900/30",
      mockup: <ChatMockup />,
      delay: 0.1,
      size: 'large'
    ...
    {
      title: t("servicestab.tile2title"),
      description: t("servicestab.tile2description"),
      gradient: "from-purple-900/30 to-violet-900/30",
      mockup: <StrategyFlow />,
      delay: 0.2,
      size: 'normal'
    ...
    {
      title: t("servicestab.tile3title"),
      description: t("servicestab.tile3description"),
      gradient: "from-violet-900/30 to-purple-900/30",
      mockup: <ModelChart />,
      delay: 0.3,
      size: 'small'
    ...
    {
      title: t("servicestab.tile4title"),
      description: t("servicestab.tile4description"),
      gradient: "from-fuchsia-900/30 to-pink-900/30",
      mockup: <DataPipeline />,
      delay: 0.4,
      size: 'wide'
    ...
    {
      title: t("servicestab.tile5title"),
      description: t("servicestab.tile5description"),
      gradient: "from-fuchsia-900/30 to-pink-900/30",
      mockup: <AITrainingMockup />,
      delay: 0.5,
      size: 'wide'
    ...
    {
      title: t("servicestab.tile6title"),
      description: t("servicestab.tile6description"),
      gradient: "from-blue-900/30 to-violet-900/30",
      mockup: <SystemMonitor />,
      delay: 0.6,
      size: 'small'
      ...
      <div className="relative z-10 pt-32 pb-20">
        <div className="container mx-auto px-8 lg:px-16 xl:px-20 2xl:px-24">
          ...
          <div className="text-center mb-16">
            ...
            >
              {t("servicestab.heading1")} {" "}
              <span className="bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
                {t("servicestab.heading2")}
              </span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
