...
const ServiceStatsSection = () => {
    ...
    const stats = [
        {
            label: t('servicestab.statslabel1'),
            value: 98,
        },
        {
            label: t('servicestab.statslabel2'),
            value: 100,
        },
        {
            label: t('servicestab.statslabel3'),
            value: 96,
        }
    ];
        ...
        >
            ...
            <div className="relative z-10 text-center mb-10">
                <h3 className="text-2xl md:text-3xl font-bold mb-3 bg-gradient-to-r from-white via-gray-100 to-blue-100 bg-clip-text text-transparent">
                    {t('servicestab.servicestatsheadingtab')}
                </h3>
                <p className="text-gray-300 text-sm max-w-xl mx-auto">
                    {t('servicestab.servicestatspara')}
                </p>
            </div>
