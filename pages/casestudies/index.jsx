...
import { ChevronRight, Target, Award, X, Clock, CheckCircle, FileText, Zap, Shield } from 'lucide-react';
...
const CaseStudiesTab = () => {
  ...
  const caseStudies = [
    {
      id: 1,
      title: "AI Agent for Guarantee Office",
      category: "AI Automation",
      image: "./guarantee-office.jpg",
      tileBackground: "bg-gradient-to-br from-emerald-50 to-teal-50",
      buttonGradient: "from-emerald-500 to-teal-500",
      description: "Developed an AI agent that processes thousands of diverse, unstructured warranty reports monthly, transforming manual workflows into automated intelligent processing.",
      metrics: [
        { label: "Time Savings", value: ">90%", icon: Clock },
        { label: "Defect Detection", value: "~100%", icon: Shield },
        { label: "Processing Speed", value: "20 sec/doc", icon: Zap }
      ],
      problems: [
        "Thousands of diverse, unstructured reports monthly",
        "Need to preserve elastic, not systematized reporting",
        "Manual report processing takes valuable expert time",
        "Mistakes during manual processing cause delays or loss of key information"
      ],
      solutions: [
        "AI agent independently processes variety of reports (PDFs, images, handwritten text)",
        "Automated analytics for decision makers",
        "24/7 lightning fast processing",
        "Employees now play auditor role, focusing on strategic work"
      ],
      developmentTime: "7 days",
      detaileddescription: "Working with the company's warranty office, we developed a thorough understanding of the problem and designed a prototype in just 7 days. The AI agent processes diverse report formats including PDFs, images, and handwritten text with near-perfect accuracy. The system provides 24/7 automated processing, completing each document in just 20 seconds while maintaining over 90% effectiveness in detecting defects. This transformation shifted employees from repetitive manual work to strategic auditing roles, eliminating hundreds of hours of repetitive tasks and associated costs."
    },
    {
      id: 2,
      title: "Legal Document Intelligence",
      category: "Legal Tech",
      image: "./legal-department.jpg",
      tileBackground: "bg-gradient-to-br from-indigo-50 to-purple-50",
      buttonGradient: "from-indigo-500 to-purple-500",
      description: "Revolutionized legal document processing with AI Agent for a major legal department.",
      metrics: [
        { label: "Time Saved", value: " >80%", icon: Clock },
        { label: "Number of Documents", value: "9000", icon: FileText },
        { label: "Accuracy", value: "90%", icon: CheckCircle }
      ],
      problems: [
        "Hundreds of legal documents requiring manual review",
        "Preperation of Legal documents is time-consuming and error-prone",
        "Difficulty analysis of court documents",
        "High error rates in clause identification and analysis"
      ],
      solutions: [
        "AI Agent that helps with clause extraction and categorization",
        "Time Savings in searching for information in the legal documents database",
      ],
      developmentTime: "14 days",
      detaileddescription: "Our legal AI system transforms how legal departments handle contract review and analysis. The platform automatically extracts key clauses, identifies potential risks, and provides comprehensive regulatory requirements. Lawyers can now focus on strategic legal advice while the AI handles routine document processing, resulting in faster turnaround times and more consistent quality across all legal work."
    }
  ];
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto leading-relaxed mb-12">
                ...
                Explore our portfolio of innovative automation that drives measurable results.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {filters.map((filter) => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-full font-medium transition-all duration-300 border backdrop-blur-sm cursor-pointer select-none focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900 ${activeFilter === filter.key
                  ...
                  >
                    ...
                    <div className="relative h-60 overflow-hidden">
                      ...
                      {caseStudy.developmentTime && (
                        <div className={`absolute top-4 right-4 ${caseStudy.category === 'Legal Tech' ? 'bg-indigo-500/90' : 'bg-emerald-500/90'} text-white px-3 py-1 rounded-full text-sm font-semibold backdrop-blur-sm`}>
                          {caseStudy.developmentTime} prototype
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs font-semibold text-gray-600 bg-gray-200/60 px-2 py-1 rounded-full">
                          {caseStudy.category}
                        </span>
                        <Award className={`w-5 h-5 ${caseStudy.id === 2 ? 'text-indigo-600' : 'text-emerald-600'}`} />
                      </div>
                        ...
                        {caseStudy.metrics.slice(0, 3).map((metric, idx) => {
                          ...
                          return (
                            <div key={idx} className="text-center">
                              <IconComponent className="w-4 h-4 text-gray-600 mx-auto mb-1" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-orange-50 to-amber-100 shadow-xl border border-orange-100 rounded-3xl p-8 md:p-12">
              ...
              <p className="text-orange-700 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                From legal document processing to warranty management, we can automate your complex workflows in days, not months. Let's discuss your automation needs.
              </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {selectedCase.developmentTime && (
                      <span className="text-white/60 text-sm bg-white/10 px-3 py-1 rounded-full">
                        Prototype: {selectedCase.developmentTime}
                      </span>
                    )}
                  </div>
                </div>
