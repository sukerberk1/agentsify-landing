...
const WhyCaseStudiesAgentsify = () => {
    ...
    useEffect(() => {
        ...
        const strings = [
            'Why does my business need an <span class="gradient-text">AI Agent</span>?',
            'How can <span class="gradient-text">AI Agents</span> transform my business operations?',
            'What makes <span class="text-white font-semibold">Agentsify</span> <span class="gradient-text">AI services</span> the right choice?',
        ];

        let currentIndex = 0;
        const typeText = () => {
            if (typedRef.current) {
                typedRef.current.innerHTML = strings[currentIndex];
    ...
    const tileData = [
        {
            ...
            title: ["Automate", "Repetitive Business", "Tasks Efficiently"],
            description: "Leverage cutting-edge AI technology to streamline processes, save time, and reduce errors. Our automation solutions free up your team for strategic growth while ensuring optimal efficiency and accuracy.",
            features: [
        ...
        },
        {
            ...
            title: ["Enhance and Innovate", "Your Service with AI"],
            description: "Drive unparalleled service quality with AI-powered solutions designed to automate repetitive tasks, optimize workflows, and ensure precision. Empower your business to achieve excellence in every operation.",
            features: [
        ...
        },
        {
            ...
            title: ["Reduce Operational", "Costs with AI", "Solutions"],
            description: "Leverage AI to minimize operational expenses, streamline processes, and achieve cost-effective scalability. By automating key tasks, businesses can save time, reduce errors, and focus on growth opportunities.",
            features: [
            ...
            <section className="relative text-white -mt-1 pt-8 sm:pt-12 pb-6 px-4 md:px-8 min-h-screen overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-sky-300 max-w-2xl mx-auto text-sm sm:text-base md:text-lg mb-4 sm:mb-6 px-2">
                        Discover how our tailored AI solutions empower businesses to drive growth, improve efficiency, and foster innovation.
                    </p>
                            ...
                            <div className="w-full lg:w-1/2 space-y-3 sm:space-y-4">
                                ...
                                <ul className="text-gray-800 space-y-1.5 sm:space-y-2">
                                    {currentData.features.map((feature, index) => (
                                        <li key={`${currentTile}-feature-${index}`} className="flex items-center gap-2 sm:gap-3 justify-start transform transition-all duration-700 ease-in-out text-sm sm:text-base" style={{ transitionDelay: `${index * 100}ms` }}>
                                            <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full ${getIconColorClass(currentData.iconColor)} flex items-center justify-center flex-shrink-0 shadow-md`}>
                    ...
                    <div className="max-w-6xl mx-auto text-center relative z-10 mt-15">
                        <div className="mb-10 text-orange-300">
                            <h4 className="text-xl md:text-2xl font-semibold leading-snug mb-3">
                                Explore Our{' '}
                                <a href="/casestudies" className="hover:opacity-80 transition-opacity duration-300">
                            ...
                            <p className="text-emerald-300 text-sm font-extrabold md:text-base leading-relaxed max-w-3xl mx-auto">
                                Discover how our tailored AI solutions have transformed businesses by driving efficiency,
                                innovation, and growth. From improving processes to expanding client bases, our case
                                studies showcase measurable success and real-world impact.
                            </p>
                        </div>
