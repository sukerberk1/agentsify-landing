...
const BrandsReviews = () => {
    ...
    const texts = [
        { text: "Discover what powers", highlight: "Agentsify." },
        { text: "Unveiling the", highlight: "AI technology stack." },
        { text: "Explore tools behind", highlight: "AI innovation." }
    ];
            ...
            >
                ...
                <div className="pt-24 pb-8 md:pb-12 lg:pb-20 px-4 max-w-6xl mx-auto text-center relative z-20">
                    <div className="mb-16">
                        ...
                        >
                            Learn about the advanced AI tools and technologies we
                            leverage to deliver exceptional results for our clients.
                        </p>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto text-center relative z-50 px-2 mt-8 md:mt-16 lg:mt-24">
                        ...
                        >
                            <p className="text-gray-200 text-sm md:text-base max-w-xl mx-auto leading-relaxed relative px-4">
                                Don't just take our words for it, take a look at our work as well.
                                <span
